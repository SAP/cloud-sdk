...
You find the ID of a business partner via the endpoint `http://localhost:8080/business-partners`.
...
If you execute `GET http://localhost:8080/business-partners/1003764` afterward, you should see the additional address for the business partner.
...
To verify you can execute `GET http://localhost:8080/business-partners/1003764` afterward and the selected address should be removed.
