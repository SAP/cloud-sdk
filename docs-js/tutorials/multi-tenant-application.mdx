...
In this chapter you learn how to create the possibility to call the service from a different account.
...
However, the subscriber account does not know anything about the internal details of our application.
