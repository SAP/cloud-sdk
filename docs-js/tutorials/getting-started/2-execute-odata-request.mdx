...
This will create a folder `business-partners` in the `src/` directory containing the controller `business-partner.controller.ts`.
...
import { BusinessPartnerController } from './business-partners/business-partner.controller';
...
More details of the OData generator can be found in [Generate an OData client for JavaScript](../../features/odata/generate-odata-client).
...
import { BusinessPartnerService } from './business-partners.service';
...
<Tabs groupId="code-files" defaultValue="bupa-controller" values={[{ label: 'src/business-partners/business-partner.controller.ts', value: 'bupa-controller'}, { label: 'src/business-partners/business-partners.service.ts', value: 'bupa-service'}, { label: 'src/app.module.ts', value: 'app-module'}]}>
...
import { AppService } from './app.service';
import { BusinessPartnerController } from './business-partners/business-partner.controller';
import { BusinessPartnerService } from './business-partners/business-partners.service';
