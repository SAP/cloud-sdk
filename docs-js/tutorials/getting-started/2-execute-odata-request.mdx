...
destinations='[
  {
    "name": "TESTINATION",
    "url": "http://url.hana.ondemand.com",
    "username": "DUMMY_USER",
...
For more information on local destinations, check out or [destination documentation](../../features/connectivity/destinations#local-environment-variable).
:::
