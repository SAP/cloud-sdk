...
This can either happen via a generated [OData](/odata/execute-odata-requet) or [OpenAPI](/openapi/execute-opemapi-request) client or the [http client](/connectivity/generic-http-client).
...
As a simple example assume you want to ensure that your response data does not contain only uppercase characters.
...
You find detailed information on the resilience topic in a [dedicated documentation](../guides/how-to-add-resilience).
