...
This can either happen via a generated [OData](/odata/execute-odata-requet#setting-middlewares) or [OpenAPI](/openapi/execute-opemapi-request#setting-middlewares) client or the [http client](/connectivity/generic-http-client#setting-middlewares).
