...
In this section you learn how to implement a middleware based on a 'hello world' example.
The following middleware logs "Hello World" and leaves the original function unchanged.
...
If you want to trigger your logic on function execution you have to create a new function in the middleware.
...
If you want to process the result of the function your middleware implement something like
