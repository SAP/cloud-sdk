...
If you must use a globally installed generator, you have to install the`@types/node` and `@sap-cloud-sdk/openapi` package in your project to make the transpilation work.
