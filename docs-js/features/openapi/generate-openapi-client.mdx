...
| `-t`, `--transpile`,                           | Transpile the generated TypeScript code. When enabled a default `tsconfig.json` will be generated and used. It emits `.js`, `.js.map` and `.d.ts` files. To configure transpilation set `--tsconfig`.                                                                                                                                                             |
