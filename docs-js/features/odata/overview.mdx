...
[Executing a request using a generated OData client](./execute-odata-request.mdx#conversion-of-odata-types) will automatically convert EDM data types to JavaScript/TypeScript values.
