...
You can specify middlewares for the request via the `middleware()` method on the request builder:
...
A typical use case for middlewares is to add [resilience](../guides/how-to-add-resilience) to your request.
The concept is more general and can be used to add [arbitrary enhancements of the request](../middleware).
