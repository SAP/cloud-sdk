...
>
  <TabItem value="v2">
    <li>
      <a href="./odata-v2-client#getall-request-builder">
        <code>getAll</code>
      </a>{' '}
      Build requests to get a list of entities (OData v2)
    </li>
    <li>
      <a href="./odata-v2-client#getbykey-request-builder">
        <code>getByKey</code>
      </a>{' '}
      Build requests to get an entity based on a key (OData v2)
    </li>
    <li>
      <a href="./odata-v2-client#create-request-builder">
        <code>create</code>
      </a>{' '}
      Build requests to create entities (OData v2)
    </li>
    <li>
      <a href="./odata-v2-client#update-request-builder">
        <code>update</code>
      </a>{' '}
      Build requests to update entities (OData v2)
    </li>
    <li>
      <a href="./odata-v2-client#delete-request-builder">
        <code>delete</code>
      </a>{' '}
  ...
  <TabItem value="v4">
    <li>
      <a href="./odata-v4-client#getall-request-builder">
        <code>getAll</code>
      </a>{' '}
      Build requests to get a list of entities (OData v4)
    </li>
    <li>
      <a href="./odata-v4-client#getbykey-request-builder">
        <code>getByKey</code>
      </a>{' '}
      Build requests to get an entity based on a key (OData v4)
    </li>
    <li>
      <a href="./odata-v4-client#create-request-builder">
        <code>create</code>
      </a>{' '}
      Build requests to create entities (OData v4)
    </li>
    <li>
      <a href="./odata-v4-client#update-request-builder">
        <code>update</code>
      </a>{' '}
      Build requests to update entities (OData v4)
    </li>
    <li>
      <a href="./odata-v4-client#delete-request-builder">
        <code>delete</code>
      </a>{' '}
