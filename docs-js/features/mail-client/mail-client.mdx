...
This documentation describes how you can send e-mails from application deployed on the SAP BTP to your e-mail servers.
...
As mentioned in this [documentation](https://help.sap.com/docs/CP_CONNECTIVITY/cca91383641e40ffbe03bdc78f00f681/cd1583775afa43f0bb9ec69d9dbcc880.html?locale=en-US) of the SAP BTP, using `SOCKS5` proxy for accessing `On-Prem` systems from applications on SAP BTP needs `SOCKS5` authentication flow.
