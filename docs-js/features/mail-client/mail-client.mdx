...
You send the e-mail by calling the `sendMail()` function with your `mailConfig` as argument:
...
You can read more about the abstraction of the `destination` in the documentation [here](connectivity/destinations).
