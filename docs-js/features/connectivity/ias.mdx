...
- [`getIasToken()`](pathname:///api/v4/functions/sap-cloud-sdk_connectivity.getIasToken.html) fetches an IAS token.
...
```typescript
import { createDestinationFromIasService, getIasToken } from '@sap-cloud-sdk/connectivity';
