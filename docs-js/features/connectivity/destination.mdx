...
- `jwt`: The JSON Web Token.
  ...
  - Multi-tenant scenarios with destinations maintained in the subscriber account. This case is implied if the the  `selectionStrategy` is set to `alwaysSubscriber`.
