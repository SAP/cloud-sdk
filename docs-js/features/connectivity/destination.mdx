...
- `cacheVerificationKeys`: This property is deprecated since v4.0.3 and has no effect as the SDK no longer verifies the incoming JWT when fetching a destination.
