...
### SAMLAssertion
the SAP Cloud SDK adds the `x-sap-security-session: create` header for requests to destinations with authentication type SamlAssertion to create those sessions automatically.
