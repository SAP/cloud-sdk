...
This cache is always enabled and be behaves similarly to the destination cache discussed above.
It uses the same default [isolation strategies](#isolation-strategy).
