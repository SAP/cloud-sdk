...
This guide explains how you can execute arbitrary HTTP requests using the SAP Cloud SDK for JavaScript.
...
If you use OData or OpenAPI, you should use generated clients if possible.
