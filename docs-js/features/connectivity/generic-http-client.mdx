...
Custom parameters can be useful when you need control excatly how values are transmitted to the backend system.
...
The term "origin" as it is used in the context of this guide does **not** refer to [an URL as in the "same-origin policy"](https://developer.mozilla.org/en-US/docs/Glossary/Origin).
