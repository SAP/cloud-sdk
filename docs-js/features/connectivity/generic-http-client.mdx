...
In case the OData or OpenAPI client does not satisfy your requirements, the next thing you should look into is the HTTP client which is explained in this guide.
