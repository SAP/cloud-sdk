...
If the [OData client](../odata/execute-odata-request.mdx) can satisfy your requirements, it is always recommended to use that client directly as it provides the best convinience for interacting with OData APIs.
...
In this example the `custom` api key and param override the request config:
