...
If the [OData client](../odata/execute-odata-request.mdx) or [OpenAPI Client](../openapi/execute-openapi-request) can satisfy your requirements, it is always recommended to use that client directly as it provides the best convenience.
