...
| Operates dynamically on the metadata and creates an on-the-fly-client. | Typed API clients can be [generated](./features/odata/generate-odata-client). An [generic, untyped client](./features/connectivity/generic-http-client.mdx) is also available. |
