...
## Module `@sap-cloud-sdk/http-client` not found

The [SAP Cloud Application Prgramming Mode (CAP)](https://cap.cloud.sap/docs/) uses the SAP Cloud SDK to execute HTTP requests towards [external services](https://cap.cloud.sap/docs/guides/using-services?q=http-client).
