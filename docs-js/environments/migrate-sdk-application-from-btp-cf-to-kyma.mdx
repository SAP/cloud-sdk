...
[Kyma](https://kyma-project.io/docs/kyma/latest/01-overview/) is an open-source project, offering a comprehensive suite of tools and services, specifically created for the development and operation of cloud-native applications seamlessly integrated with Kubernetes.

# Getting Started with the SAP Cloud SDK on Kyma

This guide is meant for helping you migrate your existing application built with the SAP Cloud SDK for JavaScript to Kyma.
...
We will also deploy an approuter so that only authenticated users can access your application.
...
- A node.js application using the SAP Cloud SDK and an approuter
  :::info
  If you do not have an application already, you can use the [example application](https://github.com/SAP-samples/cloud-sdk-js/tree/main/samples/helm-sample-application/application) and [approuter](https://github.com/SAP-samples/cloud-sdk-js/tree/main/samples/k8s-sample-application/approuter).
  :::
