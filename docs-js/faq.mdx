...
In simple words, the Virtual Data Model is a nick-name for pregenerated type-safe client libraries for allowlisted OData services of [SAP S/4HANA Cloud](https://www.sap.com/germany/products/s4hana-erp.html).
