...
The [samples repository](https://github.com/SAP-samples/cloud-sdk-js/tree/main/samples/resilience-examples) gives you examples which illustrate the concepts and pick some widely used packages.
