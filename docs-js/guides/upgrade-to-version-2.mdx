...
We introduced a new [(de-)serialization](../features/odata/odata-v2-client#customize-de-serialization) to make this more flexible.

If you would like to switch to the [Temporal](https://tc39.es/proposal-temporal/docs/) (de-)serialization for date/time objects, please follow the [documentation](../features/odata/odata-v2-client#using-de-serializers-for-temporal) and adjust your code base.
...
For the implementation of the [(de-)serializers](../features/odata/odata-v2-client#customize-de-serialization), two changes are introduced in version 2.0:
...
To make the [middle ware concept](../features/odata/odata-v2-client#customize-de-serialization) possible, it was necessary to add more state to the `requestBuilder`.
