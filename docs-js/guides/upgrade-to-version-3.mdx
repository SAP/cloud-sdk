---
id: upgrade-to-version-3
title: How to upgrade to version 3 of the SAP Cloud SDK for JavaScript
hide_title: false
hide_table_of_contents: false
sidebar_label: Upgrade to version 3
description: This document will guide you through the upgrade process from version 2 to 3.
---
