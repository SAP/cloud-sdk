...
Finally look at how to serve your service at the root of your subdomain.
...
3. After creating a container image, create a deployment and a service to run and expose the application router.
...
A complete example of an ingress that only exposes the application router and is using the annotations is shown in the following example:
