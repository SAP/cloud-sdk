...
title: Download Specification Files from SAP Business Accelerator Hub
sidebar_label: Download specification files
description: This guide demonstrates the steps to download OData and OpenAPI specification files (specs) from SAP Business Accelerator Hub.
---
