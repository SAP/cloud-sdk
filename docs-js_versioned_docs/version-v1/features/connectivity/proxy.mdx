...
A detailed step-by-step guide on using a type-safe client is provided in our getting started tutorial series.
(Only available for the latest version of the SAP Cloud SDK)
