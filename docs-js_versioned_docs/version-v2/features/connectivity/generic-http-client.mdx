...
The most basic way to use the SAP Cloud SDK HTTP client is the function [executeHttpRequest](pathname:///api/v2/functions/sap_cloud_sdk_http_client.executeHttpRequest.html).
...
- The `destination` argument is of type `DestinationOrFetchOptions`
  - This can either be a [destination object](pathname:///api/v2/interfaces/sap_cloud_sdk_connectivity.Destination.html) which was already fetched or an [object containing a destination name and an optional JWT](pathname:///api/v2/interfaces/sap_cloud_sdk_connectivity.DestinationFetchOptions.html)
- The `requestConfig` argument is of type [HttpRequestConfig](pathname:///api/v2/types/sap_cloud_sdk_http_client.HttpRequestConfig.html) or [HttpRequestConfigWithOrigin](pathname:///api/v2/types/sap_cloud_sdk_http_client.HttpRequestConfigWithOrigin.html)
...
The `executeHttpRequest()` function returns a promise of type [HttpResponse](pathname:///api/v2/interfaces/sap_cloud_sdk_http_client.HttpResponse.html).
...
See its [API documentation](pathname:///api/v2/interfaces/sap_cloud_sdk_http_client.HttpRequestOptions.html) for details.
