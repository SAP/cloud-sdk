...
If you want to publish a generated client to an npm registry, in addition to transpiling you will need to have a `package.json` for your client.
You can generate it with `--packageJson` or include your custom `package.json` with `--include`.
