...
The first parameter is either a [destination](pathname:///api/v2/interfaces/sap_cloud_sdk_connectivity.Destination) object or [DestinationFetchOptions](pathname:///api/v2/interfaces/sap_cloud_sdk_connectivity.DestinationFetchOptions).
...
The SAP Cloud SDK API documentation of the complete `SmtpTransportOptions` can be found in the API doc [here](pathname:///api/v2/interfaces/mailclient_src.SmtpTransportOptions).
