...
The OpenAPI related functionality of the SAP Cloud SDK is currently not compatible with Spring Framework 6.
More information can be found on the [related documentation](/docs/java/features/rest/overview).
