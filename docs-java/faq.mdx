...
If you found a feature that you need, but it is not yet supported by SAP Cloud SDK for Java.
Please make a feature request via email [cloudsdk@sap.com](mailto:cloudsdk@sap.com) or create an issue towards one of our repositories.
