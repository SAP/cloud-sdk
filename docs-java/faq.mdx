...
After adding a `com.sap.cloud.security.client.HttpClientFactory`, there are now 2 HttpClientFactory.
The existing HttpClientFactory can be removed before the application starts:
