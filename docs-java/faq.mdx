...
SAP Cloud SDK can be used with JakartaEE (e.g. via Spring Boot 3, Spring 6, and Java 17) thanks to the experimental modules `servlet-jakarta` and `apache-httpclient5`.
