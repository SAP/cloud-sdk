...
- Dependency Updates:
  ...
  - Other dependency updates:
    - Minor version updates:
      - Update [Spring Framework](https://search.maven.org/search?q=g:org.springframework%20AND%20a:spring-framework-bom) (`org.springframework:spring-framework-bom`) from `5.3.25` to `5.3.26`
        - Update [Spring Boot](https://search.maven.org/search?q=g:org.springframework.boot%20AND%20a:spring-boot) (`org.springframework.boot:spring-boot`) from `2.7.8` to `2.7.10`
        - Update [Spring Security](https://search.maven.org/search?q=g:org.springframework.security%2BAND%2Ba:spring-security-bom) (`org.springframework.security:spring-security-bom`) from `5.8.1` to `5.8.2`
