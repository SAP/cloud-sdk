...
Please refer to the [Upgrade Guide](./guides/4.0-upgrade) for details instructions on how to upgrade your SAP Cloud SDK dependencies to our new major version and for a detailed list of changes.
