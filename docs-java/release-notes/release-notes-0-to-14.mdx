...
- Dependency Updates:
  ...
  - Other dependency updates: - Minor version updates: - Update [Gson](https://search.maven.org/search?q=g:com.google.code.gson%2BAND%2Ba:gson) (`com.google.code.gson:gson`) from `2.9.0` to `2.10.0` - Update `com.fasterxml.jackson` from `2.13.4` to `2.14.0` - Update `com.auth0:java-jwt` from `4.0.0` to `4.2.1` - Update [Spring](https://search.maven.org/search?q=g:org.springframework%2BAND%2Ba:spring-framework-bom) (`org.springframework:spring-framework-bom`) from `5.3.22` to `5.3.23` - Update [Spring Boot](https://search.maven.org/search?q=g:org.springframework.boot%2BAND%2Ba:spring-boot-starter-reactor-netty) (`org.springframework.boot:spring-boot-starter-reactor-netty`) from `2.7.3` to `2.7.5`
  <!-- vale on -->
