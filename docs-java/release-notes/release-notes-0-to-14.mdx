...
- Dependency Updates:
  - SAP dependency updates:
    ...
    - Update [Spring Boot](https://search.maven.org/search?q=g:org.springframework.boot%20AND%20a:spring-boot) (`org.springframework.boot:spring-boot-dependencies` and `org.springframework.boot:spring-boot-maven-plugin`) from `2.7.6` to `2.7.8`
