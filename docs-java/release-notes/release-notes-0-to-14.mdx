...
- The _SAP Java Buildpack_ related dependency `com.sap.cloud.sjb.cf:cf-tomee7-bom` in `com.sap.cloud.sdk:sdk-sjb-bom` cannot be updated beyond `1.64.1` due to conflicts with _Arquillian_ based unit-test modules.
