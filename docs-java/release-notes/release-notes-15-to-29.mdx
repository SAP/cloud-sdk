...
- We are planning to discontinue support of pregenerated OpenAPI clients with SAP Cloud SDK v5 by end of the year.
  ...
  The following module and namespace is deprecated while still being fully functional and considered supported in SAP Cloud SDK v4:
...
- Add support for Spring 6 projects within the OpenApi related functionality of the Cloud SDK.
  ...
  Please refer to the [compatibility notes](#compatibilityNotes) for more details.
