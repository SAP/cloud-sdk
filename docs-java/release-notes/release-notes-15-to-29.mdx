## 5.29.0 - April 24, 2026

[All Release Changes](https://github.com/SAP/cloud-sdk-java/releases/tag/rel%2F5.29.0)

## 5.28.0 - April 14, 2026

[All Release Changes](https://github.com/SAP/cloud-sdk-java/releases/tag/rel%2F5.28.0)
...
- Added support for SAP Cloud Identity Services (SCI) `sap_id_type` and `sub` claims in OIDC principal extraction.
  When `sap_id_type=user`, the `sub` claim is now used as the [Subject Name Identifier](https://help.sap.com/docs/SAP_DATASPHERE/9f804b8efa8043539289f42f372c4862/fac3155d77154775b919ceba36ffc325.html) (User ID, Email, or Custom Attribute as configured in SCI).
...
- Fix unintended modification of `serviceNameMappings.properties` during OData service regeneration altering stored
  ...
  Please make sure, a `serviceNameMappings.properties` file is present to avoid breaking changes to your generated code.
