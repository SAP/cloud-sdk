...
- [Using the Service Catalog with the SAP Cloud SDK](https://sap.github.io/cloud-sdk/docs/java/environments/kubernetes-sap-gardener#excursion-bind-services-created-by-the-service-catalog)
