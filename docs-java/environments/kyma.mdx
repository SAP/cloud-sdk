...
4. Navigate to `Service Management > Service Bindings` and create a binding for the service instance you just created.
   ...
   The name you give to the binding will be used to create a secret which you will need in the next step.

5. The service binding created a secret which you now need to mount as a volume into your application.
