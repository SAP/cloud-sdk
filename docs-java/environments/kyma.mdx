...
In case you operate the Connectivity Proxy yourself in "untrusted mode" you can also refer to [this guide](./kubernetes-gardener#2-using-the-connectivity-proxy) for using the Connectivity Proxy without Transparent Proxy.
:::
