...
When using the Connecitivty Proxy provided by Kyma the [Transparent Proxy](https://help.sap.com/docs/CP_CONNECTIVITY/cca91383641e40ffbe03bdc78f00f681/e661713ef7d14373b57e3e26b0b03b86.html) is required to connect to On-Premise systems with the SAP Cloud SDK for Java.
In case you operate the Connectivity Proxy yourself in "untrusted mode" you can also refer to [this guide](./sap-btp-kubernetes-environment-with-sap-gardener#2-using-the-connectivity-proxy) for using the Connectivity Proxy without Transparent Proxy.
:::
