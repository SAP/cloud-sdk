...
In case you operate the Connectivity Proxy yourself in "untrusted mode" you can also refer to [this guide](./sap-btp-kubernetes-environment-with-sap-gardener) for using the Connectivity Proxy without Transparent Proxy.
:::
