...
<details>
  <summary>Limitations of the Transparent Proxy</summary>
...
- Custom headers and parameters not yet supported

</details>

Approach **(2)** does not come with the above limitations, but imposes limitations on the operation mode.

<details>
  <summary>Limitations of the Connectivity Proxy</summary>
...
:::tip
We generally recommend to go with approach (1) unless the given limitations apply to your use case.
:::
...
Consequently, your app itself does not interact with destination or connectivity service at all and thus does not require bindings to these two services.
...
:::caution Installing the Transparent Proxy
This guide assumes you have both the Transparent Proxy and Connectivity Proxy installed in your cluster.
Please refer to [this](https://help.sap.com/docs/CP_CONNECTIVITY/cca91383641e40ffbe03bdc78f00f681/1c18e0ca10884dad994fc3d7e1d046d7.html) and [this](https://help.sap.com/docs/CP_CONNECTIVITY/cca91383641e40ffbe03bdc78f00f681/23fc1100c60b45c58f09694b7f9c7700.html) documentation on how to install it if you haven't already.
:::
...
When using the Connectivity Proxy exclusively, without Transparent Proxy, you need to pass dedicated configuration to your deployment.

:::caution Installing the Connectivity Proxy
This guide assumes you have the Connectivity Proxy installed in the _"untrusted"_ mode in your cluster.
Please note that the untrusted mode requires a service binding or service key for an XSUAA service instance.
You will need this binding/key in the steps below.

Please refer to [this](https://help.sap.com/docs/CP_CONNECTIVITY/cca91383641e40ffbe03bdc78f00f681/23fc1100c60b45c58f09694b7f9c7700.html) documentation on how to install it if you haven't already.
:::
...
:::tip Troubleshooting
An error that no connectivity service binding could be found is an indicator that the secret is not configured correctly.
You should double check the JSON, the secret and the volume mounts.
:::
