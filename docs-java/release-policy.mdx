...
| Version | Status      | Release Date | Upgrade guide                                                        |
| :------ | ----------- | :----------- | -------------------------------------------------------------------- |
| 2.x     | Deprecated  | May 2017     | N/A                                                                  |
| 3.x     | Maintenance | August 2019  | [Link](https://developers.sap.com/tutorials/s4sdk-migration-v3.html) |
| 4.x     | Released GA | October 2022 | [Link](guides/4.0-upgrade)                                           |
| 5.x     | Planned     | October 2023 | N/A                                                                  |
