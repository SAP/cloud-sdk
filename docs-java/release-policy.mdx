...
- We continue to [support](/docs/common/overview/get-support) customers using any version of the SAP Cloud SDK for Java.
...
Check our [support channels](/docs/common/overview/get-support) and choose the one working best for you.
