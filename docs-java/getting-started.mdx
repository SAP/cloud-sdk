...
The SAP Cloud SDK is compatible with all current Long-Term-Support (LTS) releases of Java: 8, 11 [and 17](faq.mdx#do-you-support-spring-boot-3-and-java-17).
...
SAP Java Buildpack can also be [configured to run with Java 11 and 17](https://help.sap.com/docs/btp/sap-business-technology-platform/sapmachine#activation)
:::
