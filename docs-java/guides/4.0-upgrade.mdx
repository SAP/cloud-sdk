...
For more information also check out our [version 4 release blog post](https://blogs.sap.com/2022/03/01/sap-cloud-sdk-for-java-4.0-building-the-next-major-version/).
:::
...
Most API allows for easy mocking already.
...
In case you are running on Kubernetes like Kyma or Gardener you can benefit from the improved integration.
...
- Make sure your apps have an environment variable `SERVICE_BINDING_ROOT` set to `/etc/secrets/sapbtp/`
