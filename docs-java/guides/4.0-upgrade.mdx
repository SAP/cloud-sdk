...
- Make sure to use the latest version of the [SAP BTP Environment Variable Access (aka Service Binding) Library](https://github.com/SAP/btp-environment-variable-access) (minimum `0.5.1`)
