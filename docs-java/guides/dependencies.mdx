...
SAP Cloud SDK can be used with JakartaEE (e.g. via Spring Boot 3, Spring 6, and Java 17) thanks to the module `servlet-jakarta`.
Here are instructions on how to update your application:
...
- Please note, some dependencies are not yet fully compatible for Java17 or Spring Boot 3.
