...
:::danger Warning
The BOM for the SAP Java Buildpack (SJB) `sdk-sjb-bom` has been deprecated.
The latest tested SJB version is 1.71.0 with SDK 4.16.0.
From now on, whenever you switch to a newer version of the SJB, it might not be magically compatible with the SDK.
In that case, feel free to open a [support issue](https://sap.github.io/cloud-sdk/docs/java/support).
