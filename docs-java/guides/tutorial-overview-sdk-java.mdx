...
9. [Extensibility and Type-Safe Expand with the Virtual Data Model for OData](https://developers.sap.com/tutorials/cloudsdk-extensibility-type-safe-expand.html)

   Use the latest features of the SAP Cloud SDK regarding eager and type-safe expand, and extensibility with the Virtual Data Model for OData for any SAP S/4HANA system.
