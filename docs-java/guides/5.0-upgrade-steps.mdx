  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>-</td>
        <td>
          You can use version 4 of the auditlog artifact with version 5 of the SAP Cloud SDK. Please refer the [Auditlogging usage](./5.0-upgrade-steps#auditlogging-usage) section below for more details.
