...
- Others
  - `com.sap.cloud.sdk.cloudplatform:auditlog` (See [Auditlogging usage](./5.0-upgrade-steps#auditlogging-usage) section below)
  - `com.sap.cloud.sdk.cloudplatform:auditlog-scp-cf` (See [Auditlogging usage](./5.0-upgrade-steps#auditlogging-usage) section below)
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>-</td>
        <td>
          You can use version 4 of the auditlog artifact with version 5 of the SAP Cloud SDK. Please refer the <a href="#auditlogging-usage">Auditlogging usage</a> section below for more details.
          ...
          <br />
          This change also affects the Auditlog integration with the S/4HANA Connectivity module. You will have to explicitly use `AuditLogger` to log events.
        </td>
      </tr>
      <tr>
...
You would have to manually add all of the following artifacts(only available internally) to your project:
