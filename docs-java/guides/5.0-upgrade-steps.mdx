  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>-</td>
        <td>
          You can use version 4 of the auditlog artifact with version 5 of the SAP Cloud SDK. Please refer the <a href="https://sap.github.io/cloud-sdk/docs/java/guides/5.0-upgrade-steps#auditlogging-usage">Auditlogging usage</a> section below for more details.
