...
Furthermore, you need to have generated a client library for your OData service.
...
The service is represented by the `BusinessPartnerService` class which you can obtain by [generating a client](vdm-generator) for the Business Partner service.
