...
As described in our [Resilience section](/docs/java/features/resilience) the SAP Cloud SDK allows you to run any code in the context of one or more resilience patterns.
...
See the section on isolation levels under [Resilience](/docs/java/features/resilience#multi-tenancy) for more details.
