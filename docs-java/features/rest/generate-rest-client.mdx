...
The following chapter will explain how to use the OpenAPI Generator Maven Plugin.
A sample result can be seen in our [open-source public repository](https://github.com/SAP/cloud-sdk-java/tree/main/datamodel/openapi/openapi-api-sample): the soda store example.

After generation the following API is available:
...
Services can be instantiated with:
