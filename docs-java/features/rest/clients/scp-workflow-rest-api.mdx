...
You can check the SAP BTP Workflow API's model definition on the [SAP Business Accelerator Hub](https://api.sap.com/package/SAPCPWorkflowAPIs?section=Artifacts) or use your IDE to discover available properties via its auto-complete function.
