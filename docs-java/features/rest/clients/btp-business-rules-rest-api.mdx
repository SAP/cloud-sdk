...
:::danger Warning
The Business Rules Client `btp-business-rules` has been deprecated.
We are planning to discontinue support of this module with SAP Cloud SDK v5 by end of 2023.

Alternatively, you can generate the APIs by using the [OpenAPI](../generate-rest-client) generator with the YAML specification of the service.
:::
