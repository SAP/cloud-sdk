...
To benefit from features offered by the REST APIs of the SAP BTP Business Rules service.
You can leverage the type-safe client library provided by the **SAP Cloud SDK** and discover it via your IDE.
