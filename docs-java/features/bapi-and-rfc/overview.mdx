...
Please consider searching for an OData based service (e.g., via SAP Business Accelerator Hub) as possible replacement. The SAP Cloud SDK also offers OData type safe clients (both OData v2 and v4).
