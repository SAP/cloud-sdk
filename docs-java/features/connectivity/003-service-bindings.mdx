...
- The [SAP Identity and Authentication Service (IAS)](https://help.sap.com/docs/identity-authentication)
  - For IAS please see the [dedicated section below](#using).//TODO
...
For services backed by the SAP Identity and Authentication Service (IAS), please see the [dedicated section below](#using).//TODO
For other services, please refer to the section on [customization](#customization). //TODO
...
If your service is secured using IAS and is using the [dedicated service binding format](#using) //TODO supported by the SAP Cloud SDK, you can obtain a destination by passing the service label as the `ServiceIdentifier`:
