...
The SAP Cloud SDK supports using certificates provided by ZTIS to authenticate to BTP services.
For example:
...
Aside from connecting to BTP services, you can also obtain or enhance any `HttpDestination` to use the certificate provided by ZTIS.
