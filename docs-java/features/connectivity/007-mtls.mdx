...
Head over to the [official documentation](https://pages.github.tools.sap/pse/pse-docs/docs/identity/) and [sample code](https://github.tools.sap/pse/blueprints/tree/main/examples/cf/java/ztis-identity/cf-manifest) to learn more about how to use ZTIS.

:::

To enable support by SAP Cloud SDK for certificates provideded by ZTIS in your application, you need to add the following dependency to your `pom.xml`:
