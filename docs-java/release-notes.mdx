...
- Update the OData VDM to the [newest release 2208 of SAP S/4HANA Cloud](https://blogs.sap.com/2022/08/01/highlights-of-the-sap-s-4hana-cloud-2208-release/). This includes completely new services (available as usual in packages `com.sap.cloud.sdk.s4hana.datamodel.odata.services` and `com.sap.cloud.sdk.s4hana.datamodel.odatav4.services`), new operations in previously existing services, and new entity types. The SDK supports all OData services listed in the [SAP API Business Hub for SAP S/4HANA Cloud](https://api.sap.com/products/SAPS4HANACloud/overview).
...
- Following modules have been deprecated and will be **removed** with the upcoming release of Cloud SDK version 4:
...
- Check out our new [Feature Matrix](./overview-cloud-sdk-for-java#feature-matrix). We're actively extending it. Let's us know what you'd like to see there by creating a [GitHub issue](https://github.com/SAP/cloud-sdk/issues/new?assignees=&labels=feedback&template=feedback.md&title=).
