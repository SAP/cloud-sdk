...
The SAP Cloud SDK for Java provides tenant and principal isolation to any piece of code you write involving features like resilience patterns,caching etc to ensure that code you write is executed in a tenant aware manner.
