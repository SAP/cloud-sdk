...
You can generate your own API client for [OData](https://sap.github.io/cloud-sdk/docs/js/features/odata/generate-client) or [OpenAPI](https://sap.github.io/cloud-sdk/docs/js/features/openapi/generate-client) using the respective generators provided by the SAP Cloud SDK.
