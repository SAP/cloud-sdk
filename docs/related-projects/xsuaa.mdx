...
This ensures full coverage of authentication methods available on SAP Cloud Platform with high level of security and ongoing updates provided by the underlying library.
...
Follow our [release notes](../js/release-notes-sap-cloud-sdk-for-javascript-and-typescript) to find out when migration happens.
