...
## What is User Account and Authentication for Cloud Foundry Environment?

[Cloud Foundry environment](https://help.sap.com/viewer/3504ec5ef16548778610c7e89cc0eac3/Cloud/en-US/9c7092c7b7ae4d49bc8ae35fdd0e0b18.html) is one of the key environments of the [SAP Business Technology Platform](https://www.sap.com/products/cloud-platform.html).

[User Account and Authentication (UAA)](https://docs.cloudfoundry.org/concepts/architecture/uaa.html) is the identity and management service for Cloud Foundry environment.
...
It greatly extends capabilities for SAP BTP Cloud Foundry environment UAA service by providing:
