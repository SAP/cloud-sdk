...
Check out our quick guide about [getting started](/docs/java/guides/cap-sdk-integration) with the SDK for Java in a CAP project.

Another option is a [step-by-step tutorial](https://developers.sap.com/tutorials/cloudsdk-integrate-cap.html) to help you jump-start use of the SAP Cloud SDK for Java with CAP.
