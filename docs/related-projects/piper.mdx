...
The SDK is shipped with the pre-configured general-purpose pipeline which is a part of the project "Piper" and allows you to start with continuous delivery without writing any pipeline code - only declarative configuration is required.
