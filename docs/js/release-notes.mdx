...
:::note _Release notes_ for the Open Source components

For the Open Source modules of the SAP Cloud SDK for JavaScript we maintain [release notes](https://github.com/SAP/cloud-sdk-js/releases) on GitHub.
...
For your convenience we [pregenerate type-safe client libraries](https://www.npmjs.com/search?q=%40sap%2Fcloud-sdk-vdm-*) (also known as Virtual Data Model or VDM for short) for allow-listed OData services of SAP S/4HANA Cloud, Marketing Cloud and SAP S/4HANA On-premise.
...
- **We released a regular update for pregenerated client libraries (also known as VDM) for the [latest RTC release 2102 of SAP S/4HANA Cloud](https://news.sap.com/2021/02/sap-s4hana-cloud-2102-empowering-businesses-seize-opportunities/).**
  - The update covers all the changes to existing OData services and introduces new ones.
- **We released a regular update for pregenerated client libraries (also known as VDM) for the latest RTC release 2020 FSP1 of SAP S/4HANA On-premise.**
  - The update covers all the changes to existing OData services and introduces new ones.
