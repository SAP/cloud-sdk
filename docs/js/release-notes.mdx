...
This is crucial to determine the tenant, if the `tokenServiceUrlTyp` of the destination is [common](https://help.sap.com/viewer/cca91383641e40ffbe03bdc78f00f681/Cloud/en-US/e3c333f9de6245fca326993f2397c13a.html).
- Fix missing X-tenant header if the authentication flow is `OAuth2ClientCredentials` and the `tokenServiceUrlTyp` of the destination is [common](https://help.sap.com/viewer/cca91383641e40ffbe03bdc78f00f681/Cloud/en-US/4e1d742a3d45472d83b411e141729795.html).
