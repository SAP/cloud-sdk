...
## Should I update?
We highly recommend to update to the latest SDK version regularly. It will help you:
...
For your convenience we [pre-generate type-safe client libraries](https://www.npmjs.com/search?q=%40sap%2Fcloud-sdk-vdm-*) (also known as VDM) for allowlisted OData services of SAP S/4HANA Cloud, Marketing Cloud and SAP S/4HANA On-premise. These libraries are not Open Source, but free. They are distributed under the SAP Developer license through [npmjs.com](https://www.npmjs.com/search?q=%40sap%2Fcloud-sdk-vdm-*).
:::
