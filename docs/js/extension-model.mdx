...
- Onboarding session with SAP Cloud SDK team. Get to `Hello World!`
...
- SAP Cloud SDK team provides a repository structure and initial content as needed. This helps the contribution team to kick-start their pipeline.
...
- Pull request need to be reviewed by at least one of the SAP Cloud SAP Cloud SDK team members
...
- The contribution team has to set on a regular release cycle.
  SAP Cloud SDK uses 2 weeks released cycle and it's preferred regularity.
