...
We outline our plans regarding the SAP Cloud SDK version 2.x in this document.
...
So far, we have always stayed backward compatible to avoid migration efforts for you.
