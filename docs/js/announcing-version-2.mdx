...
This announcement only applies to the SAP Cloud SDK for JavaScript and is not relevant for the SAP Cloud SDK for Java.

:::

# Announcing Version 2.x for the SAP Cloud SDK for JavaScript
...
We outline our plans regrading the SAP Cloud SDK version 2.x in this document.

## Abstract

- We will release a new major version every 6 to 12 months with version 2.x expected in January 2022
- We will ensure that upgrading will take minimal effort and provide a step-by-step guide
- We will provide fixes and new features only for the most current version of the SAP Cloud SDK after it's released GA.
...
Please [reach out to us](https://github.com/SAP/cloud-sdk-js/discussions/1518) with your feedback, suggestions or improvement ideas.
...
We will regularly release new major versions aiming for a 6 to 12 months release-cycle.
Between major releases, we will continue with a biweekly release cycle to deliver minor version updates with non-breaking changes.
...
We aim at making migration possible within 1 day regardless of the project size.
...
You can always count on our [support and advice](../overview/support.mdx) with migration.

## Will Old Major Versions Be Maintained?

We will not provide bug fixes or back-port features into older releases.
The SAP Cloud SDK is an open source project, you can contribute a fix or a feature if you prefer staying with an older release.
It's, however, discouraged because of accumulated risks of incompatible changes in the SAP Business Technology Platform ecosystem.
We recommend you upgrade early to get access to any new fixes and features.
This will also minimize your future update path.
