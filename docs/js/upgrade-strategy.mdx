...
The SAP Cloud SDK for JavaScript was released over 2 years ago in March 2019.
...
We will outline our plans regrading the schedule for major releases, SAP Cloud SDK version 2 and developer support in this document.
...
Please [reach out to us](https://github.com/SAP/cloud-sdk-js/discussions) if you have feedback, suggestions or improvements!
