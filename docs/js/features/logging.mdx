...
description: How the SAP Cloud SDK logs errors and exception
keywords:
  - sap
  - cloud
  - sdk
...
If `myLogger.error(err)` is called with an error object it will also log also the stack trace:
...
In case you see a need for a higher flexibility of the logging instance feel free to create an issue in our [repository](https://github.com/SAP/cloud-sdk-js) or make a contribution
