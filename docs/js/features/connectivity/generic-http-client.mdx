...
<img
  ...
  src={useBaseUrl('img/odata-client-layers.png')}
  class="center"
  width="50%"
/>
...
**OData Client:** Provides strong typing for the request (payload, select, filter, ...) and response.
...
The [request configuration](pathname:///api/1.28.1/interfaces/sap_cloud_sdk_core.httprequestconfig) argument contains the request configuration.
