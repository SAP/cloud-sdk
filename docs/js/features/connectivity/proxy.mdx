...
For different systems like SAP SuccessFactors, SAP Sales Cloud, and many others you can generate a type-safe client yourself.
...
Hence, the SAP Cloud SDK switches off the build-in proxy handling by `axios` completely by using:
