...
All you have to do it look up an API definition on [SAP API BusinessHub](https://api.sap.com/) and invoke a [generator](../odata/generate-odata-client.mdx) supplied with [SAP Cloud SDK for JavaScript](https://github.com/SAP/cloud-sdk-js).
...
<img alt="Destination in CF" src={useBaseUrl('img/proxyTypeDestination.png')} height="300" />
