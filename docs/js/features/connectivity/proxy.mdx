...
1. A local proxy running on the cloud platform used to connect to S/4HANA OnPremise systems.
...
and adds them to the `axios` configuration. The agents contain the proxy configuration.
