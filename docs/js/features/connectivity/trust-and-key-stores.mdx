...
description: This article describes how to configure trust and keystores in the SAP Business Technology Platform and how the SDK handles them.
keywords:
  - sap
  - cloud
  - sdk
...
1. You are talking to the party you expect you talk to.
2. The content of your conversation is encrypted and therefore private.
...
:::caution
The SAP Cloud SDK for JavaScript only supports `.pem` as certificate format.
:::
...
:::caution
The SAP Cloud SDK for JavaScript only supports `.P12` and `.PFX` as formats for the keystore.
:::
