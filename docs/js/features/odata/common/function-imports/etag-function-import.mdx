Function and action imports do not support `ETag` handling automatically.
...
With this approach, you have to retrieve the required entity with a `getByKey` request, before executing the function import.
