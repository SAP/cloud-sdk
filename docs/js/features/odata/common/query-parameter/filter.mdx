...
The EDM primitive types support all six comparison operators: `lessThan()`, `lessOrEqual()`, `equals()`, `notEquals()`, `greaterOrEqual()`, and `greateThan()`.

</TabItem>

<TabItem value="deprecated">

Filters are built via the static property fields on entities:
