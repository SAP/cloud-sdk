...
If a changeset was executed sucessfully, its corresponding response is of type `WriteResponses` and contains a collection of all raw responses to the requests in the changeset.
