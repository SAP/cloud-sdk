...
This guide explains how to use features of the [OData v4 protocol](https://www.odata.org/documentation/) supported by the SAP Cloud SDK. We will use [People service from OData v4 tutorial](https://www.odata.org/getting-started/advanced-tutorial/) and [Business Partner Service](https://api.sap.com/api/API_BUSINESS_PARTNER/resource) from the SAP S/4HANA ERP suit.
