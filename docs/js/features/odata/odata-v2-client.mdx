...
This guide explains how to use features of the [OData v2 protocol](https://www.odata.org/documentation/odata-version-2-0/) supported by the SAP Cloud SDK. To demonstration the features we will use the [Business Partner Service](https://api.sap.com/api/API_BUSINESS_PARTNER/resource) from the SAP S/4HANA ERP suit.
