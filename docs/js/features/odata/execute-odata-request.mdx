...
Usually, it is recommended to use `execute` method to retrieve the deserialized typed response.
Sometimes, you might prefer to retrieve the raw response and the original request:
