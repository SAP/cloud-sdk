...
In some cases you might prefer to retrieve the unserialized raw response:
...
To retrieve a raw response for your request use the `executeRaw` method.

:::note Best Practice: Retrieve typed responses using `execute()`
