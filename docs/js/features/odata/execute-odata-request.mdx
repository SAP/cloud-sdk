...
Once the request is configured use the `execute` function and pass a [destination](../connectivity/destination-js-sdk) to it.
...
Automatically generated headers are sent with lower case header names, custom header keep the case they were set in.
