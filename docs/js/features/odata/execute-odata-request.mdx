...
Executing the example request above against a destination with URL `https://my.s4-system.com` would result in a request against URI like this: `https://my.s4-system.com/my/custom/service/path/MyEntity`.
