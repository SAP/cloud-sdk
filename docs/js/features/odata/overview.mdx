...
- SAP S/4HANA OnPremise: `@sap/cloud-sdk-op-vdm-<service name>-service`
...
- [S/4HANA Cloud on the SAP Business Hub](https://api.sap.com/products/SAPS4HANACloud/overview)
- [S/4HANA On-Premise on the SAP Business Hub](https://api.sap.com/products/SAPS4HANA/overview)
