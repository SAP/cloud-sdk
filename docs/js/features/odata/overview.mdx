...
- We ship pre-generated OData clients for the SAP S/4HANA OData services. They are also referred to as the _Virtual Data Model_ or _VDM_. You can find a list of all those services in the [SAP API Business Hub](https://api.sap.com/package/SAPS4HANACloud?section=Artifacts) (check the ODATA box).
