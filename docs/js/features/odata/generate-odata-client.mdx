...
You can then easily access these services via the client libraries.
...
:::note
The generator is included in the SAP Cloud SDK CLI.
If you installed the CLI, you don't need to install the generator separately.
:::
...
- TypeScript code (`.ts`) including request builders, entity representations and if needed representations for complex types as well as function/action imports.
...
| :----------------------------------------------------- | :-------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--inputDir`, `-i` _(required)_                        |                 -                 |  This directory will be recursively searched for `.edmx`/`.xml` files.                                                                                                                               |
| `--outputDir`, `-o` _(required)_                       |                 -                 |  Directory to save the generated code in.                                                                                                                                                            |
