...
If you must use a globally installed generator, you have to install the`@types/node` and `@sap-cloud-sdk/odata-v2` or `@sap-cloud-sdk/odata-v4` package in your project to make the transpilation work.
