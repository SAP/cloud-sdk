...
This differs from the OpenAPI generator and will likely change in the next major version upgrade.

If you want to publish a generated client to an npm registry, you can work with the default configuration.
Please make sure to check inellectual property regulations before publishing to a public registry.
