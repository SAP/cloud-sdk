...
By default, it transpiles the generated sources to JavaScript and provides a `package.json` for the client (this differs from the OpanAPI generator).
...
If you installed the generator globally, transpilation will fail unless you install the required odata packages.
