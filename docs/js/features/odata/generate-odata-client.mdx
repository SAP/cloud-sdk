...
If you installed the generator as a `devDependency`, transpilation will work, however, for productive use, you may have to define the dependency productively.
