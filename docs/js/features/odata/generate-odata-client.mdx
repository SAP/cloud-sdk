...
- TypeScript code (`.ts`) represents request builders, entity representations and if needed representations for complex types as well as function/action imports.
