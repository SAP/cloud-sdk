...
It is technically separated into two services per environment: the Inbox API (OData) and the Workflow API (OpenAPI).
...
The first SAP Cloud SDK pregenerated OpenAPI client is for the OpenAPI Workflow API.
There is no pregenerated client for the Inbox API, yet.
The remainder of this document will refer to the OpenAPI Workflow API for Cloud Foundry only.
...
To learn how to setup your environment to use the SAP Workflow service, please refer to the [Workflow service documentation](https://help.sap.com/viewer/e157c391253b4ecd93647bf232d18a83/Cloud/en-US/fc3d44872c354742afd672aa8d9c16b4.html).
:::
