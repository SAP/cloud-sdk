...
The generator generates per default also JavaScript sources. `generateJS`.XXX

A default tsconfig.json is used in the transpilation process.
If you want to use your one config profide the path via the flag `tsConfig`:
