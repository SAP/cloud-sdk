...
The `directoryWithOpenApiFiles` points to the directory containing your specification file and `outputDirectory` to the target folder where generated client will be saved.
