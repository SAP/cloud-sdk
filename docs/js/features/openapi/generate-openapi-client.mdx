...
There is an upcoming community call on using the OpenAPI Client Generator of SAP Cloud SDK for JS for the easy consumption of OpenAPI services on June 23rd 2020.
