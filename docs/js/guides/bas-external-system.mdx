...
The Business Application Studio (BAS) is a development environment offered as a service on Cloud Foundry environment (CF).
...
You have a Cloud Foundry environment account and a subscription to the BAS.
