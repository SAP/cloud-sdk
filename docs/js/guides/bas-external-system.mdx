...
In case you use principal propagation, the BAS will fill the `SAP-Connectivity-Authentication` header as discussed in the [OnPremises connectivity guide.](../feature/connectivity/on-premise)
