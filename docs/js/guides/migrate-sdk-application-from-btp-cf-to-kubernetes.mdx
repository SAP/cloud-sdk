...
4. Finally, configure the Ingress to be aware of the session-cookie created by the AppRouter and point at the AppRouter service.
   ...
   For that you just need specify the service names in your AppRouter's `xs-app.json` and remove the previous rules you created for these endpoints in the Ingress.
