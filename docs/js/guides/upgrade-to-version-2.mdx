...
If you would like to switch to the [temporal](https://tc39.es/proposal-temporal/docs/) serialization for date/time objects, please follow the [documentation](../features/odata/use-odata-v2-type-safe-client-for-javascript-typescript#using-temporal-middleware) and adjust your code base.
