...
This document will guide you through the steps necessary to upgrade to version 2.0 of the SDK.
...
__Prerequisite___: You tried to do the steps above but hit some impediments.
