...
- [Update Public API Clients - possible after beta phase](#update-public-api-clients)
...
- [Get Support if you face a problem in the upgrade process](../../overview/support.mdx)
