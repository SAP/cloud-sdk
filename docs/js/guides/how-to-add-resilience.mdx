...
In this article, we will talk about resilience and what are the easy ways to add resilience on top of the SAP Cloud SDK.
...
This is not a classical resilience topic but could help to improve the stability of your application.
...
- The execution of a method is expensive, i.e., it consumes a lot of resources
- The method is a pure function or close to it. This means the function arguments contain all the information and no hidden state affects the result of the function
