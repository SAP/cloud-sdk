...
Old:
![file-generator.js in ES5](./img/es5.png)

New:
![file-generator.js in ES19](./img/ecma2019.png)
...
To give you a sneak peak, here an example for a middleware to serialize `Edm.DateTime`, `Edm.DateTimeOffset` and `Edm.Time` to `temporal`:
