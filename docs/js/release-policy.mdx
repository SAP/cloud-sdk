...
- We will use tabs to demostrate a difference between the versions where required.

<Tabs groupId="version" defaultValue="major" values={[ { label: 'v2', value: 'major' }, { label: 'v1', value: 'deprecated' } ]}>
...
- At all times we will maintain documentation only for two most recent versions.
