...
The OData v2, v4, and OpenAPI libraries build the foundation for (pre-)generated client libraries.
They contain OData and OpenAPI specific abstractions, that the client libraries (custom and pregenerated) use to expose their APIs.
