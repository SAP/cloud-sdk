...
You will develop an application which provides a REST API to manage addresses of business partners.
...
Since the follow-up part is about changing data, we recommend to use a [local mock system](https://sap.github.io/cloud-s4-sdk-book/pages/mock-odata.html).
...
![](../img/get-all-business-partners.png)
