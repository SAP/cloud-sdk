...
In this part of the tutorial, you will to the following:
...
Navigate to the mock server project's root folder, that already contains a `manifest.yml` and run:
...
This tells Cloud Foundry in SAP Business Technology Platform to create an instance of the destination service with service plan _lite_ and make it accessible under the name `my-destination`.
