...
description: This is a getting started guide for anyone willing to contribute to the Cloud SDK documentation.
keywords:
  - sap
  - cloud
  - sdk
...
Install `Node.js` and `npm` if necessary. You can use the latest LTS release.
