...
- Less than 5 minutes? - **just do it, no need for backlog item**
- 15 minutes - 2 hours - **depending on your and team's preferences add it to the backlog or to you personal ToDo**
- \> 2 hours - **Add to backlog and track together with the team**
...
6. Showcase your knowledge, creativity, and markdown skills by delivering concise but useful documentation. Please,
...
Please, make sure you followed [these best practices](how-to-write-documentation) or at least run your writing through the spell checker.
