...
A browser tab with the starting page of documentation portal should open automatically.
Try navigating to [http://localhost:3000/](http://localhost:3000/) as a fall back option.
...
You can check [GitHub actions](https://github.com/SAP/cloud-sdk/actions?query=workflow%3A%22Release+Cloud+SDK+documentation%22) for Documentation or navigate to live documentation portal and check if your changes are applied.
...
**Tabs? Admonitions? Advanced code blocks? Your own plugin?**
