...
Not that much.
Speaking is a natural way to transfer information for humans.
...
Notice, `careful` is better then `cautious`, because careful is higher frequency word for this context.
...
When appropriate passive voice if fine.
...
I found 16 issues in this document after checking it with free version of [Grammarly](https://www.grammarly.com/).
...
Make something imperfect and improve with every versions.
