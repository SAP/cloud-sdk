...
- [If you need an example of bad documentation check OData Specification](http://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part1-protocol.html)
...
appropriate. Instead of **This feature was developed by us so that you are made happy** try to use something like this **We
...
relevant. Be mindful and check copyrights if copying too much. Bookmark a couple of favorite documentation web-sites
...
field](http://docs.oasis-open.org/odata/odata-json-format/v4.01/odata-json-format-v4.01.html#sec_ControlInformationtypeodatatype). Don't spend too much time on it...

#### MVP

Don't be hard on yourself. Make something imperfect and improve with every versions. Any documentation is better than no
