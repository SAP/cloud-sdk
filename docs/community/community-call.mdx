...
- in-depth focus topics around the SDK
- the SDK's roadmap
The call series is conducted by the SAP Cloud SDK development and product management team.
We will introduce the SAP Cloud SDK and cover its latest updates along with a deep dive on the topic chosen for the day.

The community update calls take place every second Tuesday of a given month.
On this page, you can find the schedule as well as recordings of past sessions below.

[Register for the series.](https://sap-se.zoom.us/webinar/register/WN_dBtYmF5IR7Gb8TMjHqEvhw)

We are working on enabling registering for individual sessions instead of a series, we will keep you posted on the progress.
