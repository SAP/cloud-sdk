...
In 2020 we ran two sessions of a workshop about extending S/4HANA in a cloud-native way.
No worries if you have missed it!

Check the introduction deck to understand why side-by-side extensibility matters and how to do it in a healthy instead of a toxic way.
...
The exercise for this workshop is hosted in this [GitHub repository](https://github.com/SAP-samples/teched2020-DT261). You can run all the code locally or deploy it to the SAP Cloud Platform and test it there.
For that, we recommend creating a free trial account and activating Business Application Studio.
You'll find detailed instructions on how to do it in the `README` of the repository.
