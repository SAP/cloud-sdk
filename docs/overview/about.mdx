...
By choosing the SAP Cloud SDK you also chose a carefully selected set of standards and best development practices allowing for a fail-safe, agile, and streamlined software delivery process.
To make sure you get a kick start into developing wiht the SAP Cloud SDK we relentlessly update this documentation and run [community events](../community/community-call.mdx).
