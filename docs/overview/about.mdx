...
The SAP Cloud SDK is a versatile set of libraries and tools for developers to build cloud-native applications on the SAP Business Technology Platform (BTP).
Our goal is to simplify the life of developers working in the SAP ecosystem by abstracting the complexities of the SAP BTP and letting them keep the focus on the application's business logic.
...
By choosing the SAP Cloud SDK you also chose a curated set of standards and best development practices allowing for a fail-safe, agile, and streamlined software delivery process.
To make sure you get a kick start into developing with the SAP Cloud SDK we relentlessly update this documentation and run [community events](../community/community-call.mdx).
...
- [SAP Cloud SDK for JavaScript](../js/overview-cloud-sdk-for-javascript)
