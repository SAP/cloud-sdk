...
Check out our detailed [getting started guide](../js/getting-started) for more information.
:::
...
This example assumes you're running macOS or Linux.
[Check detailed getting started guide for your platform](../java/getting-started)
:::
...
- [Tutorials covering SAP Cloud SDK for JavaScript on the SAP Developers portal](https://developers.sap.com/tutorial-navigator.html?tag=products:technology-platform/sap-cloud-sdk/sap-cloud-sdk&tag=topic:javascript)
...
### Mock and Test Servers for OData and S/4HANA

- We created a [service](https://github.wdf.sap.corp/MA/book-bupa-mock-odata) that mocks S/4HANA Business Partner service. You can host it on your own machine to pracice with the SAP Cloud SDK.
