...
The dependencies differ with respect to the type of **S/4HANA** system([**SAP S/4HANA Cloud**](https://api.sap.com/package/SAPS4HANACloud?section=Artifacts) or [**SAP S/4HANA On-Premise 2020**](https://api.sap.com/package/S4HANAOPAPI?section=Artifacts)):

<Tabs groupId="s4hana" defaultValue="s4hanacloud" values={[ { label: 'S/4HANA Cloud', value: 's4hanacloud', }, { label: 'S/4HANA On-Premise 2020', value: 's4hana_onpremise', }]}>
