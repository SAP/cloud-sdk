...
:::note
Please note the above mentioned archetypes work out-of-the-box for Cloud Foundry. For Neo platform we provide an archetype `scp-neo-javaee7` for only servlet based projects.
:::
</Tabs>
...
**Congratulations!ssss You've just set up a brand new application with the SAP Cloud SDK for Java.**
...
<Tabs groupId="s4hana" defaultValue="s4hanacloud" values={[ { label: 'SAP S/4HANA Cloud', value: 's4hanacloud', }, { label: 'SAP S/4HANA On-Premise 2020', value: 's4hana_onpremise', }]}>

<TabItem value="s4hanacloud">
...
<TabItem value="s4hana_onpremise">
...
:::note
Please note for Spring based projects we provide out-of-the-box support only on Cloud Foundry with archetype `scp-cf-spring`.
:::
...
- [Check tutorials for SAP Cloud SDK for Java](https://developers.sap.com/tutorial-navigator.html?tag=products:technology-platform/sap-cloud-sdk/sap-cloud-sdk&tag=topic:java)
