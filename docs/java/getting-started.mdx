...
If you want to use a type safe **OData** client library for [**SAP S/4HANA On-Premise 2020**](https://api.sap.com/package/S4HANAOPAPI?section=Artifacts) then the following dependency should be added to your project:
