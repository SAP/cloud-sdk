...
We intend to release a new **major version** every **six to twelve months** to introduce significant feature upgrades, refactor existing features, and clean up deprecated code.
...
- We continue to [support](./../overview/support.mdx) customers using any version of the SAP Cloud SDK for Java.
...
Check our [support channels](../overview/support.mdx) and choose the one working best for you.
