...
- Updating individual fields (in contrast to updating the entire object) of nested complex properties is not reflected correctly in the actual **PATCH** request.
