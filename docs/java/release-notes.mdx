...
- Removed Swagger annotations `ApiModel` and `ApiModelProperty` from classes generated by the [OpenAPI client generator](features/rest/generate-openapi-client.mdx)
