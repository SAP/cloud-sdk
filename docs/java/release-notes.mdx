...
- The module `cxf` uses the Apache CXF dependencies of version `3.3.10` which is affected by vulnerabilities [CVE-2021-30468](https://nvd.nist.gov/vuln/detail/CVE-2021-30468).
