...
[Maven Central](https://search.maven.org/search?q=g:com.sap.cloud.sdk*%20AND%20v:3.47.0) | [Javadoc](https://help.sap.com/doc/55bb1642ea614bf582d514ed34401136/1.0/en-US/index.html)
...
- We fixed an issue in the Javadoc generation for the OData V4 VDM, which caused the content of the `Core.Description` annotation to be ignored.
