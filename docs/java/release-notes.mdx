...
- Add the remaining changes since `3.58.0` to our update of the OData VDM with the [newest release 2111 of SAP S/4HANA Cloud](https://news.sap.com/2021/10/sap-s4hana-cloud-2111-innovating-business-futures/).
...
- Fix a race-condition issue when serializing OData V2 VDM entity objects concurrently in multiple threads.
