...
These can be called Tenants (e.g. in the context of XSUAA) or Zones (e.g. in the context of IAS).

The SAP Cloud SDK for Java uses the term _Tenant_ to abstract over both of them.
