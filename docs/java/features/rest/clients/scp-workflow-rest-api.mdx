...
To benefit from features offered by the REST API of the SCP Workflow service you can leverage type-safe client library provided by the **SAP Cloud SDK** and discover it via your IDE or [manually integrate it into your application](https://help.sap.com/viewer/e157c391253b4ecd93647bf232d18a83/Cloud/en-US/df943e71122448caaf3c49f5ffd80627.html).
