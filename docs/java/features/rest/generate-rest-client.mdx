...
The REST generator is basically a wrapper around the public open-source OpenApi generator where we have adjusted the Mustasche templates to integrate the generated client library with the SDK core. 
...
The maven plugin xml should be added to the `application/pom.xml` file of your project: 
