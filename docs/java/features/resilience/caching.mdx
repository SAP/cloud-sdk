...
As described in our [Resilience section](https://sap.github.io/cloud-sdk/docs/java/features/resilience/resilience) the Cloud SDK allows you to run any code in the context of one or more resilience patterns.
