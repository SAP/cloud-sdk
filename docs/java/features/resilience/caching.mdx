...
First of all, you may remove individual cache entries by:
...
This operation is implicitly tenant/principal aware and also considers parameters defined in the `CacheConfiguration` when choosing which entries to remove.
