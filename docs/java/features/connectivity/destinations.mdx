...
Authentication flows (like OAuth 2.0 Client Credentials) are usually performed by the Destination Service.
...
The SAP Cloud SDK does not implement most of the authorization flows itself. 
