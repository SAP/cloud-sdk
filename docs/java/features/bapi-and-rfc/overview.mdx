...
- _destinationName_: Defines which SAP BTP destination to use for connecting to SAP S/4HANA.
...
### Configure the SAP Business Technology Platform, Cloud Foundry Environment
