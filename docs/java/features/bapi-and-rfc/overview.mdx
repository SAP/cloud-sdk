...
Furthermore, if you want to call JCo from any newly created thread, please check out the documentation [here](https://help.sap.com/viewer/cca91383641e40ffbe03bdc78f00f681/Cloud/en-US/b14eeb94be944c62a5880bde50c59aef.html). Be aware to exclude the `java-api` artifact, since this is transitively included with the SDK!
