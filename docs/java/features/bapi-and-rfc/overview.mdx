...
Furthermore, please check out the documentation [here](https://help.sap.com/viewer/cca91383641e40ffbe03bdc78f00f681/Cloud/en-US/b14eeb94be944c62a5880bde50c59aef.html), especially if you want to call JCo from any newly created thread.
:::caution Transitive dependency

Be aware to exclude the artifacts mentioned above, since they are transitively included with the SAP Cloud SDK.
...
Please visit the [dependency guide](../../guides/manage-dependencies) for more information.
