...
:::note OData Read request

At the moment we do not provide type-safe API for adding OData Read requests to Batch.
You can work around it for now with generic [OData Client](./generic-odata-client.mdx#odata-v2-batch-read-request).
