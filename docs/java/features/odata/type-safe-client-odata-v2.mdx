...
Please, check what filter options are supported by [OData v2 standard](https://www.odata.org/documentation/odata-version-2-0/uri-conventions/). Search for: **4.5. Filter System Query Option ($filter)** after navigation to the link.
