...
The Cloud SDK simplifies the consumption of OData services through the following features:
...
- For many popular SAP OData services we ship pre-generated type-safe clients.
  In the SAP universe, they are called Virtual Data Model or VDM.
...
- Service definition usually comes in form of `.edmx` file and contains metadata of OData service.
  ...
  You can generate a client for any 3rd party service or a service that you've built on your own.
