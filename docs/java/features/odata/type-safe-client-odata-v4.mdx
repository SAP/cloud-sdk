...
At the moment the SAP Cloud SDK for Java does not provide a typed API to make such requests. However, you can leverage our [Generic OData Client](generic-odata-client.md) to simplify the logic of making such requests.
