...
SAP Cloud SDK for Java has first-class support for [BTP Cloud Foundry environment](https://www.sap.com/germany/products/business-technology-platform.html).
...
Let us know if you're missing any features about BTP Cloud Foundry environment support from the SAP Cloud SDK for Java.
...
However, we do not recommend starting new projects with SAP Business Technology Platform Neo as Cloud Foundry environment is better suited for apps and SAP S/4HANA extension development.
