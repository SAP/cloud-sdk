...
Yes, we do support [OpenAPI 2.0 also known as Swagger](https://swagger.io/specification/v2/), and  [OpenAPI 3.0](https://swagger.io/specification/) specifications. The latter is preferred.
