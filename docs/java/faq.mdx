...
The SAP Cloud SDK for Java has first-class support for [BTP Cloud Foundry environment](https://www.sap.com/germany/products/business-technology-platform.html).
