...
## Request via SAP Cloud Connector fails with HTTP 407
...
- You cache the `HttpDestination` instance in your application code instead of retrieving it for each request.
