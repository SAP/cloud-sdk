...
- Your project uses the [GSON library](https://github.com/google/gson) in version `2.8.5`. 
  This could happens if you do not use the SAP Cloud SDK Bill-of-Material.
