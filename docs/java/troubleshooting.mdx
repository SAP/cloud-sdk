...
## java.lang.ClassNotFoundException: com.sap.hcp.cf.logback.encoder.JsonEncoder
...
- Your project settings use the [Logback library](http://logback.qos.ch/) for application logging. 
...
Also, use the SDK Bill-Of-Material in your POM to manage the version of this dependency.
