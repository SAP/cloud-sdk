...
- The performance significantly drops after the app is deployed to SAP Business Technology Platform - Cloud Foundry environment and CPU utilization is always around 100%.
...
- BTP Cloud Foundry environment provides 1/4 of CPU unit per every GB of memory.
  With maximum memory per instance of 8 GB, you can get a maximum of 2 CPU cores.
- All the limitations are subject to change.
  Please check the latest details about [SAP BTP Cloud Foundry Environment quotas and limitation](https://help.sap.com/viewer/3504ec5ef16548778610c7e89cc0eac3/Cloud/en-US/9c7092c7b7ae4d49bc8ae35fdd0e0b18.html#loio9809fa4f02cb4696baea5c23d6eaac94)
