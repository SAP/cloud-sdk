...
- The Destination Service on Cloud Foundry is unable to generate an authentication token that will be used in later requests.
  ...
  Please find the official [documentation from the Destiantion Service](https://help.sap.com/viewer/cca91383641e40ffbe03bdc78f00f681/Cloud/en-US/42a0e6b966924f2e902090bdf435e1b2.html) for more details.
