...
:::info **Symptoms**
When accessing an OnPremise system from your local machine the HTTP client is unable to establish a secure connection to the target server. You may experience the follow-up error message: `"ODataConnectionException: Connection was aborted."`.
:::
