...
In a nutshell, Gardener is a thin layer of conventions on top of the plain Kubernetes.
...
- The list below is only for inspiration. You know for what we are creating the tests.
