...
1. Add the following parameter to your invocation of the JVM:
   ...
   One example for this might be in the Dockerfile of your application:
...
5. Let your IDE connect against `localhost:5005`.
   The specifics of this step depend heavily on your choice of IDE, so we cannot give fits-all solution.
