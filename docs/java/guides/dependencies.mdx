...
:::note Alternative: SDK Modules Bill-of-Material
Besides the SDK Bill-of-Material `sdk-bom` there is also the SDK Modules Bill-of-Material `sdk-modules-bom` which manages the version of all SAP Cloud SDK modules only.
