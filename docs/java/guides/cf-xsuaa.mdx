...
When developing and deploying an application it quickly becomes important to understand how authentication and authorizations work on BTP Cloud Foundry environment.
...
Several services on BTP Cloud Foundry environment require a dedicated OAuth2 access token, e.g. _Connectivity Service_ and _Destination Service_.
