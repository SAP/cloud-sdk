...
title: SAP BTP, Cloud Foundry Environment XSUAA Explained
hide_title: false
hide_table_of_contents: false
sidebar_label: CF XSUAA Service
description: Understand how the XSUAA service works on Cloud Foundry and leverage it for your applications
keywords:
  - sap
  - cloud
  - sdk
...
Several services on the SAP BTP, require a dedicated OAuth2 access token, e.g. _Connectivity Service_ and _Destination Service_.
