...
That comprises in the first place any project using the [new CAP stack](https://cap.cloud.sap/docs/) as well as the Spring Boot Maven archetype of the SAP Cloud SDK.
...
When your project uses multiple Maven modules, you need to choose the pom.xml which contains your application code.
...
We recommend you use always the [latest version](https://mvnrepository.com/artifact/org.apache.maven.plugins/maven-war-plugin) of this Maven plugin.
:::
...
Hence, you can build and deploy your Java projecet as usually.
