...
To deploy your app developed with SAP Cloud SDK to [SAP Business Technology Platform](https://www.sap.com/products/cloud-platform.html) you'll need the Cloud Foundry environment command-line interface (CLI).
...
This `war` file is a packaged version of your web-app that's going to be deployed in the SAP Cloud Foundry environment environment.

### Bind your Command-Line Interface to SAP Cloud Foundry environment

Let's associate your Cloud Foundry environment (CF) CLI to your SAP account by providing an API endpoint and logging in with your account.
