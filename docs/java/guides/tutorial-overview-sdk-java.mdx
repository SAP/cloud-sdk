...
9. [Consume Messages for Business Events from SAP S/4HANA Cloud](https://developers.sap.com/tutorials/s4sdk-consuming-messages.html)
   ...
   This deep dive focuses on how the SAP Cloud SDK simplifies the consumption of business events from SAP S/4HANA.
   It presents a sample application to demonstrate receiving and processing of business events using the Message VDM.
...
12. [Migrate an Existing Application to Version 3.0 of the SAP Cloud SDK](https://developers.sap.com/tutorials/s4sdk-migration-v3.html)
