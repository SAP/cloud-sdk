...
For this purpose, you need to use the `RequestContextRunner` from [CAP](https://cap.cloud.sap/docs/java/provisioning-api#threading-requestcontext)
...
:::info Info
This is only valid if you are using CAP/CDS versions earlier than `1.23.0`.
<details>
<summary>Wrap asynchronous calls </summary>
...
So, the code snippet from above would look like:
