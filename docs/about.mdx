...
- Simplify development using connectivity abstractions for SAP BTP: handling destinations, handling proxies, and authentication for Cloud and On-premise systems
- Prevent cascading failures through common resiliency patterns such as using retry and circuit-breaker
