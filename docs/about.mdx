...
- [SAP Cloud SDK for JavaScript](/docs/js/overview)
...
Both [JavaScript / TypeScript](https://github.com/SAP/cloud-sdk-js) and [Java](https://github.com/SAP/cloud-sdk-js) variants are open-source and available under the Apache 2.0 license.
