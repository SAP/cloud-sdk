...
OData and OpenAPI pregenerated clients have been removed, the replacement is to generate clients with the [OData](../features/odata/generator.mdx) or the [OpenAPI](../features/rest/generate-rest-client.mdx) code generator.
