...
## List of modules that have been removed with version 5 of the SAP Cloud SDK
<details>
    <summary>Full list of removed modules</summary>

- Business Logging:
  - `scp-business-logging-all`
  - `scp-business-logging-core`
  - `scp-business-logging-odata`
  - `scp-business-logging-rest`
- Blockchain:
  ...
  - `scp-blockchain`
- BTP Shared Ledger Client:
  - `btp-shared-ledger-client`
- MDI client convenience:
  - `mdi-client-convenience`
- SAP Passport:
  - `sap-passport`
- Neo related modules:
