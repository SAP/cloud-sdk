...
9. [Extensibility, Type-Safe Expand, and Dependency Injection with the Virtual Data Model for OData](https://developers.sap.com/tutorials/cloudsdk-extensibility-type-safe-expand.html)
...
10. [Migrate an Existing Application to Version 3.0 of the SAP Cloud SDK](https://developers.sap.com/tutorials/s4sdk-migration-v3.html)
