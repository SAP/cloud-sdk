...
When to update java and spring? Together or separately?
...
<details>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>PrincipalAttributeException</td>
        <td></td>
        <td></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>KeyStoreAccessException</td>
        <td>-</td>
        <td>No SDK replacement.</td>
      </tr>
      <tr>
        <td>SecretStoreAccessException</td>
        <td>-</td>
        <td>No SDK replacement.</td>
      </tr>
      <tr>
      ...
      <tr>
        <td>DependencyNotFoundException</td>
        <td></td>
        <td></td>
      </tr>
      <tr>
        <td>EntityAlreadyExistsException</td>
        <td></td>
        <td></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>StringParsingException</td>
        <td></td>
        <td></td>
      </tr>
      <tr>
        <td>UnsupportedCloudFeatureException</td>
        <td></td>
        <td></td>
      </tr>
      <tr>
        <td>MissingConfigException</td>
        <td></td>
        <td></td>
      </tr>
      <tr>
        <td>VersionNotSupportedException</td>
        <td></td>
        <td></td>
      </tr>
      <tr>
