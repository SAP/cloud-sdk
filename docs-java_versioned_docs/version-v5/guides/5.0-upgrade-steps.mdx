...
Also, make sure that you are using Java 17 or higher. Besides changing the actual compilation binary you should also adapt the following maven properties to `17` in your `pom.xml` file:
...
## 1. Change Version of Your `sdk-bom` or `sdk-modules-bom`
