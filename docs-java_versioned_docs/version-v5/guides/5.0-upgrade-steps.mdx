...
- Others
  - `com.sap.cloud.sdk.cloudplatform:auditlog` (See [Auditlogging usage](./5.0-upgrade-steps#auditlogging-usagesap-internal-only) section below)
  - `com.sap.cloud.sdk.cloudplatform:auditlog-scp-cf` (See [Auditlogging usage](./5.0-upgrade-steps#auditlogging-usagesap-internal-only) section below)
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>-</td>
        <td>
          You can use version 4 of the auditlog artifact with version 5 of the SAP Cloud SDK. Please refer the [Auditlogging usage](./5.0-upgrade-steps#auditlogging-usagesap-internal-only) section below for more details.
...
If you want to create a VDM that is compatible with the OData VDM the SDK provided in version 4, you can use this [_serviceNameMappings.properties_](../../../static/resources/SDKv4-ODatav4-serviceNameMappings.properties).
...
The file specified under _serviceNameMappingFile_ will be created and populated, if it doesn't exist yet.
If you want to create a VDM that is compatible with the OData VDM the SDK provided in version 4, you can use this [_serviceNameMappings.properties_](../../../static/resources/SDKv4-ODatav2-serviceNameMappings.properties).
...
## Auditlogging usage(SAP Internal only)
