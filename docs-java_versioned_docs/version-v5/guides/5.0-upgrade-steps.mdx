...
## 1. Change version of your sdk-bom or sdk-modules-bom dependency
...
If you are using `com.sap.cloud.sdk:sdk-sjb-bom` you will need to replace it by using the contained BOMs directly:

```xml
<dependencyManagement>
    <dependencies>
      <!-- Replace usage of com.sap.cloud.sdk:sdk-sjb-bom by the following two BOMs -->
      <dependency>
        <groupId>com.sap.cloud.sjb.cf</groupId>
        <artifactId>cf-tomee7-bom</artifactId>
        <version>${your.sjb.version}></version>
        <type>pom</type>
        <scope>import</scope>
      </dependency>
      <dependency>
        ...
        <version>${sdk.v5.version}</version>
        <type>pom</type>
        <scope>import</scope>
      </dependency>
    </dependencies>
