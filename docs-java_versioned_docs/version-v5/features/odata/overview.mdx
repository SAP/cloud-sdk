...
You can always [generate a type-safe OData client library](vdm-generator) based on API specifications available on the [SAP Business Accelerator Hub](https://api.sap.com/) or found elsewhere.
...
- You can generate clients via our Maven plugin.
