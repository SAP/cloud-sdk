...
The SAP Cloud SDK provides a [`RequestFilter`](pathname:///java-api/v5/com/sap/cloud/sdk/cloudplatform/servlet/RequestAccessorFilter.html) that will listen to incoming HTTP requests.
