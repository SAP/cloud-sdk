...
The [`DefaultHttpDestination`](pathname:///java-api/v5/com/sap/cloud/sdk/cloudplatform/connectivity/DefaultHttpDestination.html) is the default implementation of the [`HttpDestination`](pathname:///java-api/v5/com/sap/cloud/sdk/cloudplatform/connectivity/HttpDestination.html) interface and comes as part of the [`cloudplatform-connectivity` artifact](https://search.maven.org/artifact/com.sap.cloud.sdk.cloudplatform/cloudplatform-connectivity).
