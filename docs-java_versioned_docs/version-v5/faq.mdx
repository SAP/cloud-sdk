...
3. Add the new `servlet-jakarta` module:
...
4. When using the `@ServletComponentScan` annotation as suggested, please update the namespace:
...
5. Configure Cloud Foundry for Java 17
