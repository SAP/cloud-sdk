...
- This is the last planned minor version release of SAP Cloud SDK v4.
  ...
  You can [follow this guide](docs/java/guides/5.0-upgrade-steps).
...
- Fix an issue where the current principal wasn't correctly derived from the incoming request in BTP Neo applications.
