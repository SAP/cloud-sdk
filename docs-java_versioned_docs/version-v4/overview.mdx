...
<ThemedImage
  alt="Core packages"
  sources={{
    light: useBaseUrl('img/java-sdk-overview-4.png'),
    dark: useBaseUrl('img/java-sdk-overview-4.png')
  }}
  className="center"
  width="80%"
/>
...
5. [SAP BTP Neo](https://help.sap.com/viewer/ea72206b834e4ace9cd834feed6c0e09/Cloud/en-US) (Deprecated, not recommended for new projects)
