...
As described in our [Resilience section](https://sap.github.io/cloud-sdk/docs/java/features/resilience) the SAP Cloud SDK allows you to run any code in the context of one or more resilience patterns.
...
See the section on isolation levels under [Resilience](https://sap.github.io/cloud-sdk/docs/java/features/resilience#multi-tenancy) for more details.
