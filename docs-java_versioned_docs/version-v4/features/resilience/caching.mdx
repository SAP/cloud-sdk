...
As described in our [Resilience section](/docs/java/v4/features/resilience) the SAP Cloud SDK allows you to run any code in the context of one or more resilience patterns.
...
See the section on isolation levels under [Resilience](/docs/java/v4/features/resilience#multi-tenancy) for more details.
