...
- Check out our new [Feature Matrix](./overview-cloud-sdk-for-java#feature-matrix).
...
- We released experimental type-safe client generator for `OpenAPI 3.0` specification and `maven` [plugin](https://sap.github.io/cloud-sdk/docs/java/features/rest/generate-rest-client) to run it.
