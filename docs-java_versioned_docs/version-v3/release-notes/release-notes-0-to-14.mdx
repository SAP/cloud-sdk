...
- _OData client_: Update the OData VDM to the [newest release 2002 of SAP S/4HANA Cloud](https://news.sap.com/2020/01/sap-s4hana-cloud-2002-release/).
  ...
  The SAP Cloud SDK supports all OData services listed in the [SAP Business Accelerator Hub for SAP S/4HANA Cloud](https://api.sap.com/shell/discover/contentpackage/SAPS4HANACloud).
...
- As part of the update of the OData VDM to SAP S/4HANA Cloud 1908, the `OutboundDeliveryService` has been removed from the SAP Business Accelerator Hub and, as a consequence, from the SAP Cloud SDK.
...
- Message VDM: Update the message virtual data model for the [newest release 1908 of SAP S/4HANA Cloud](https://news.sap.com/2019/08/sap-s4hana-cloud-1908-new-release/).
  ...
  The SAP Cloud SDK supports all event types listed in the [SAP Business Accelerator Hub for SAP S/4HANA Cloud](https://api.sap.com/package/SAPS4HANACloudBusinessEvents?section=Artifacts).
