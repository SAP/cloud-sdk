...
- To leverage the new **OData v2 client**, you need to adjust existing code.
  Refer to [documentation on how to switch](features/odata/type-safe-client-odata-v2.mdx#switch-to-improved-odata-v2-type-safe-client) for detailed instructions.
