...
| ------------------------- | ---------------- |
| [OData v2](v2-vdm-client) | &#10003;         |
| [OData v4](v4-vdm-client) | &#10003;         |

:::tip generate a client library yourself

You can always [generate a type-safe OData client library](generate-client.mdx) based on API specifications available on the [SAP Business Accelerator Hub](https://api.sap.com/) or found elsewhere.
...
The [SAP Business Accelerator Hub](https://api.sap.com/) is where you'll find the specification for most of the SAP-published services.
